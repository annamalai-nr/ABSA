...
FName = '../../Data/EnronStuff/SelectedAspSubjSent6K_Ankit_Corrected.csv'
...
Polarities = [L.strip().split('.~')[-1].replace('.','').split(';') for L in Lines]
NewPol = []
...
with open('EnronAspCatsAnkitSents.csv','w') as FH:
